...
# Configuration Script – Arm-pzs-glb - Rev. A

This **Configuration** script is designed for the **Arm-pzs-glb** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – Arm-pzs-glb Rev. A

Este script de **Configuration** está diseñado para el modelo **Arm-pzs-glb** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
